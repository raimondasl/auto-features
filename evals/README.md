...
| does Europe PMC collide with non-biology queries? (P22) | `epmc_collision.py` ($0, no LLM/judge; sends the core-25's own queries to Europe PMC and flags MeSH-indexed results, writes evals/epmc_collision.json, pinned by tests/test_epmc_collision.py) |
