...
Complements the lexical :mod:`anonymous.search`: embeds the query and ranks papers
by cosine similarity of their cached vectors (:mod:`anonymous.embedding_cache` +
:mod:`anonymous.vec_index`). ``hybrid`` fuses the semantic and BM25 orders with
...
from anonymous import embeddings, vec_index
from anonymous.embedding_cache import default_model, embed_papers_cached
from anonymous.retrieval import rrf_fuse
