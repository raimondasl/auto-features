...
CREATE TABLE IF NOT EXISTS paper_llm_scores (
    ...
    llm_reason  TEXT,
    -- Fine-scale rescore (anonymous.finescale): the 0-9 expectation and the
...
MIGRATIONS: dict[int, list[str]] = {
    ...
    9: [
        ...
        # optional sqlite-vec index (anonymous.vec_index) is built lazily on top.
        """\
        CREATE TABLE IF NOT EXISTS paper_embeddings (
            arxiv_id    TEXT NOT NULL REFERENCES papers(arxiv_id),
            model       TEXT NOT NULL,
    ...
    15: [
        # Fine-scale actionability rescore (anonymous.finescale): the 0-9 expectation
