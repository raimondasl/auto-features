...
so Anonymous's own ranker re-filters them: the API is repo-agnostic and can return
...
from anonymous import s2_rate
from anonymous.paper_id import doi_key, is_arxiv_id
