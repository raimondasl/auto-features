...
keyword-search JSON endpoint — a good fit for Anonymous's query model. Papers are
...
from anonymous.paper_id import dedup_id, doi_key
...
def _request_json(url: str, max_retries: int = 3, base_delay: float = 5.0) -> Any | None:
    ...
    headers = {
        ...
        "User-Agent": f"Anonymous/{__version__} (+https://anonymous.4open.science/r/utility-judgments)",
    }
