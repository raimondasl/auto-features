...
from anonymous import arxiv_cache, arxiv_rate
from anonymous.config import BIGRAM_MODES, ArxivConfig, QueriesConfig
...
def to_plain_keywords(query: str) -> str:
    ...
    **It was never right, and the first telling of this was wrong.** That transform was
    ...
    `withheld` (2026-02-22), and the one-liner was written the *next day* in `withheld`
...
def build_queries(
    ...
    if queries_cfg.redact:
        ...
        from anonymous.privacy import compile_patterns, redact, redact_all
