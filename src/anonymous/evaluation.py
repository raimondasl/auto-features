...
Anonymous ships several competing ranking components — RRF hybrid retrieval, SPECTER2
...
from anonymous.config import AnonymousConfig, RankingConfig
from anonymous.metrics import mrr, ndcg_at_k, precision_at_k, recall_at_k
...
def stored_signals(
    ...
    if ranking_cfg.w_attention > 0:
        try:
            from anonymous.signals.hn import normalize_points
