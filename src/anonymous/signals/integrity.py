...
A withdrawn paper is the one case where Anonymous's ranking can be actively
...
from anonymous import arxiv_rate
...
# kept the other one anyway. Both now share `anonymous.arxiv_rate`, which is the single
...
def _base_id(arxiv_id: str) -> str:
    ...
    Delegates to :func:`anonymous.paper_id.dedup_id`. This was a third rule for one
