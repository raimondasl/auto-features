...
STAGES: tuple[Stage, ...] = (
    ...
    Stage(
        ...
        module="anonymous.citation_graph",
    ...
    Stage(
        ...
        module="anonymous.sources.hf_papers",
    ...
    Stage(
        ...
        module="anonymous.sources.s2_recommendations",
    ...
    Stage(
        ...
        module="anonymous.sources.semantic_scholar",
    ...
    Stage(
        ...
        module="anonymous.sources.openalex",
    ...
    Stage(
        ...
        module="anonymous.sources.biorxiv",
    ...
    Stage(
        ...
        module="anonymous.signals.integrity",
