...
(no network): the reference lists are fetched by :func:`anonymous.citations.fetch_references`
...
def base_id(arxiv_id: str) -> str:
    ...
    Delegates to :func:`anonymous.paper_id.dedup_id`. The name stays because it reads well
