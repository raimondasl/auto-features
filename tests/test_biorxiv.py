"""Tests for anonymous.sources.biorxiv (mocked HTTP)."""

from __future__ import annotations

from unittest.mock import MagicMock, patch

from anonymous.sources.biorxiv import collect_papers, fetch_window
...
class TestFetchWindow:
    @patch("anonymous.sources.biorxiv._request_json")
...
class TestCollectPapers:
    @patch("anonymous.sources.biorxiv.fetch_window")
