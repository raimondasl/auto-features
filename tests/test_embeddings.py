"""Tests for anonymous.embeddings."""
...
class TestEmbeddingsAvailable:
    ...
    @patch("anonymous.embeddings._get_model")
    def test_compute_embedding_returns_array(self, mock_get_model: MagicMock) -> None:
        from anonymous.embeddings import compute_embedding
...
class TestEmbeddingsUnavailable:
    @patch("anonymous.embeddings.EMBEDDINGS_AVAILABLE", False)
    ...
    def test_compute_repo_embedding_raises(self) -> None:
        from anonymous.embeddings import compute_repo_embedding
    ...
    def test_compute_paper_embedding_raises(self) -> None:
        from anonymous.embeddings import compute_paper_embedding
...
class TestCosineSimilarity:
    def test_identical_vectors(self) -> None:
        from anonymous.embeddings import cosine_similarity
